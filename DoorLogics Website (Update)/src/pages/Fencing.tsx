            ...
            {[
              ...
              >
                <div className="h-[400px] overflow-hidden">
                  <img src={fence.img} alt={fence.title} className="w-full h-full object-cover grayscale transition-all duration-1000 group-hover:grayscale-0 group-hover:scale-105" />
                </div>
