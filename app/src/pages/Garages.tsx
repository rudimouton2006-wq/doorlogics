...
import { Warehouse, Shield, Settings } from 'lucide-react';
      ...
      <div className="pt-40 pb-0 bg-white min-h-screen">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-40 md:mb-56">
            {[
              { icon: <Warehouse size={28} />, title: "ANY DOOR TYPE", desc: "Decades of experience installing and repairing sectional, roll-up, and Tip-up doors." },
              ...
              >
                ...
                <h3 className="text-2xl md:text-3xl font-black uppercase tracking-tighter mb-6 text-brand-dark leading-tight">{feature.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center mb-40 md:mb-56">
            <motion.div
            ...
            <div className="pr-0 lg:pr-12">
              <div className="mb-12">
                <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-8 text-brand-dark leading-[0.95]">Expert<br/>Installation.</h2>
              ...
              <div className="space-y-0 border-t border-brand-border/50">
                {[
                  ...
                  <div key={i} className="py-6 border-b border-brand-border/50 flex flex-col md:flex-row md:items-center gap-2 md:gap-8">
                    <span className="block text-brand-dark font-black uppercase tracking-[0.2em] text-[11px] md:w-1/3 shrink-0">
                      {item.label}
                    </span>
        ...
        <div className="w-full border-t border-brand-border/50 bg-brand-surface pt-32 pb-32">
          <div className="container mx-auto px-6 mb-16">
            <div className="max-w-2xl">
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-brand-dark mb-6">Style Index.</h2>
              <p className="text-brand-slate text-lg font-medium">A comprehensive overview of our material and design capabilities.</p>
            </div>
          </div>
          
          {/* Flush Grid with 1px borders */}
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 border-t border-l border-brand-border/50">
              {catalogueItems.map((item, i) => (
                <div 
                  key={i}
                  className="aspect-square relative group overflow-hidden border-r border-b border-brand-border/50 bg-white"
                >
                  <img 
                    src={item.img} 
                    alt={item.title} 
        ...
        <section className="py-24 border-t border-brand-border/30 text-center bg-white">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
