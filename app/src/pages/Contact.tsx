          ...
          <div className="container mx-auto px-6 relative z-10 flex flex-col items-center mt-8">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl lg:text-[8vw] font-black text-white leading-[1.1] mb-6 tracking-tight">
                Command<br />
                <span className="text-brand-primary drop-shadow-[0_0_15px_rgba(61,107,44,0.3)]">Center.</span>
              </h1>

              <p className="text-base md:text-xl text-white/80 max-w-2xl leading-relaxed font-medium">
                Submit an inquiry, book a service, or access our emergency technical pipeline immediately. We are engineered to respond.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="lg:col-span-5 flex flex-col gap-8">
              ...
              >
                <div className="relative z-10 flex flex-col items-center text-center">
                  ...
                  <h3 className="text-2xl font-black tracking-tight text-brand-dark mb-3">Urgent Breakdown?</h3>
                  ...
                  <div className="space-y-10">
                    <div className="group">
                      <span className="text-[10px] font-black text-white/60 uppercase tracking-[0.3em] mb-2 flex items-center gap-3">
                        <ShieldAlert size={14} className="text-brand-secondary" /> Technical Emergency
                      </span>
                    ...
                    <div className="group">
                      ...
                      <a href="tel:0219192221" className="block text-2xl md:text-3xl font-black text-white tracking-tight hover:text-brand-primary transition-colors duration-300">
                        021 919 2221
                      </a>
                    </div>
              ...
              <AnimatePresence mode="wait">
                {!isSubmitted ? (
                  ...
                  >
                    ...
                    <h3 className="text-4xl md:text-5xl font-black tracking-tight text-brand-dark mb-4">Request Logged.</h3>
